...
# backlog #17): the parser answers in one signature per mistake what nineteen review rounds of regular expressions over
# text could only approximate. They need Windows PowerShell, which this cross-platform validator does not assume.
