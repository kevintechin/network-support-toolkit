# Network Health Check 1.2.8 — User Manual
...
4. The window **Network Health Check Tool 1.2.8** opens and **starts by itself** within a second. You will see:
...
*NetworkHealthCheck 1.2.8. This manual describes the tool as shipped; what your IT department changed in the configuration file — targets, thresholds, the report folder — shows up in the report's rows and in its Computer and Run Information section.*
