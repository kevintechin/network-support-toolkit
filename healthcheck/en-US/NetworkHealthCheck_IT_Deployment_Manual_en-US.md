...
| `-NoTraceroute`, `-NoWifi` | Skip those two diagnostics — the only two with a switch; the wireless retry counters have neither a box nor a switch and follow `WifiRetryCounters` in the file |
