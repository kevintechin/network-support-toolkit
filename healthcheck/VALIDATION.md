...
- `parse_check.ps1`, `unit_tests.ps1`, `report_stage_tests.ps1` (was `report_stage_tests_v121.ps1`), `gui_repro.ps1`, `gui_check.ps1` — committed as they ran for 1.2.1, byte for byte.
