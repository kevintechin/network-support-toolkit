...
$transition = New-Row $r.Results[0] 'wifi-retry' 'Wireless retries' 'ERROR'; $transition.Details = 'Connection state: not listed at the start, connected at the end.' + [Environment]::NewLine + 'Interface GUID: 0b3f7c2e-1111-4a2b-9c3d-000000000002'
$gone = New-Row $r.Results[0] 'wifi-retry' 'Wireless retries' 'ERROR'; $gone.Details = 'Connection state: connected at the start, not listed at the end.' + [Environment]::NewLine + 'Interface GUID: e6b08c8a-3feb-4c3e-88c3-dee94dd2f0eb'
