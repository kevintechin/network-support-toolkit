...
|---|---|---|---|---|
| M1 | Double-click the downloaded ZIP, open `en-US\`, double-click `Start-NetworkCheck.cmd` **without extracting** | The report carries the compressed-folder warning row (backlog #18); the reports land under `%TEMP%\Temp1_…\` and disappear with the view | | screenshot + the report copied out before closing the view |
